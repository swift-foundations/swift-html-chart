...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-html-chart open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-html-chart project authors
